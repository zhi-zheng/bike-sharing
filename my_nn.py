...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += X.reshape((self.input_nodes,1)).dot(hidden_error_term.reshape((1, self.hidden_nodes)))
        # Weight step (hidden to output)
        delta_weights_h_o += hidden_outputs.reshape((self.hidden_nodes,1)).dot(output_error_term.reshape((1,self.output_nodes)))
